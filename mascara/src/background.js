...
console.log('%c   000000000000', 'color: red')
console.log(global)

const SwGlobalListener = require('./lib/sw-stream/sw-global-listener.js')// GZB MODIFY
...
async function start() {
  console.log(' %c ===MetaMask initializing...====', 'color: red')
  const initState = await loadStateFromPersistence()
  console.log(' %c ===MetaMask initState====', 'color: red')
  console.log(initState)
  await setupController(initState)
  console.log(' %c ===MetaMask initialization complete===', 'color: red')
}
...
async function setupController (initState, client) {
  ...
  connectionListener.on('remote', (portStream, messageEvent) => {
    ...
    log.debug('%c =======background**remote**portStream=============', 'color: red')
    log.debug('%c =======background**remote**messageEvent============', 'color: red')
    log.debug(portStream)
