...
const SwController = require('./lib/sw-controller')// GZB MODIFY
const SwStream = require('./lib/sw-stream')// GZB MODIFY
...
const swController = new SwController({
  fileName: './background.js',//background
  keepAlive: true,
  keepAliveDelay,
...
function connectApp() {
  ...
  return new Promise((resolve, reject) => {
    startPopup({ container, connectionStream }, (err, store) => {
      console.log('%c hello from MetaMascara ui!', 'color: red')
