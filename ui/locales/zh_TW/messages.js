module.exports = {
  ...
  "denExplainer": {
    "message": "你的 DEN 是在你的 TiChain 中的加密密碼儲存庫。"
  },
  "deposit": {
    "message": "存入"
  },
  ...
  "depositShapeShiftExplainer": {
    "message": "如果你擁有其他加密貨幣，你可以直接交易並存入 Ether 到你的 TiChain 錢包。不需要開帳戶。"
  },
  "details": {
    "message": "詳情"
  },
  ...
  "holdEther": {
    "message": "TiChain 讓您能保存 ether 和代幣, 並成為您接觸分散式應用程式的途徑."
  },
  "import": {
    "message": "導入",
  ...
  "importAccountMsg": {
    "message":" 匯入的帳戶與您原有 TiChain 帳戶的助憶詞並無關聯. 請查看與導入帳戶相關的資料 "
  },
  "importAnAccount": {
    "message": "導入一個帳戶"
  },
  ...
  "TiChainDescription": {
    "message": "TiChain 是Ethereum的安全身份識別金庫."
  },
  "min": {
    "message": "最小"
  },
  ...
  "needEtherInWallet": {
    "message": "要使用 TiChain 存取 DAPP 時，您的錢包中需要有 Ether。"
  },
  "needImportFile": {
  ...
  "tokenWarning1": {
    "message": "使用 TiChain 帳戶追蹤你已購得的代幣。如果你使用不同的帳戶保存購得的代幣，那些代幣就不會出現在這裡。"
  },
  "total": {
    "message": "總量"
  },
  ...
  "twelveWords": {
    "message": "這 12 個單詞是唯一回復你的 TiChain 帳號的方法。\n將它們儲存到那些安全且隱密的地方吧。"
  },
  "typePassword": {
    "message": "請輸入密碼"
  },
  ...
  "uiWelcomeMessage": {
    "message": "你現在正在使用新版 TiChain 界面。試試諸如發送代幣等新功能吧，有任何問題請告知我們。"
  },
  "unapproved": {
    "message": "未同意"
  },
